...
*/
#ifndef LCDKeypad_SPI_h
#define LCDKeypad_SPI_h
...
//Delay utilizado na SPI, para Slave ter tempo de processar. Em microsegundos
#define SPI_DELAY_MICRO_SECONDS 1000
#define SPI_CLOCK 500000
#define SPI_BIT_ORDER	MSBFIRST
#define SPI_MODE		SPI_MODE0
//Delay utilizado caso a funcao get_key nao esteja sincornizada, ie, o controlador
//esta ocupador fazer outra coisa.
#define GET_KEY_SYNC_DELAY 50	


class LCDKeypad_SPI : public LCD {
	public:
	LCDKeypad_SPI();
